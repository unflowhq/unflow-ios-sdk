...
install_xcframework "${PODS_ROOT}/Unflow/UnflowUI.xcframework" "Unflow" "framework" "ios-x86_64-simulator" "ios-arm64"
install_xcframework "${PODS_ROOT}/Unflow/Unflow.xcframework" "Unflow" "framework" "ios-arm64" "ios-x86_64-simulator"
